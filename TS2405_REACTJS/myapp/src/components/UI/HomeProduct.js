                ...
                <div className="col-lg-6 text-start text-lg-end wow slideInRight" data-wow-delay="0.1s">
                    <ul className="nav nav-pills d-inline-flex justify-content-end mb-5">
                        <li className="nav-item me-2">
                            <Link to ="" className="btn btn-outline-primary border-2 active" data-bs-toggle="pill" href="#tab-1">Vegetable</Link>
                        </li>
                        <li className="nav-item me-2">
                            <Link to ="" className="btn btn-outline-primary border-2" data-bs-toggle="pill" href="#tab-2">Fruits </Link>
                        </li>
                        <li className="nav-item me-0">
                            <Link to ="" className="btn btn-outline-primary border-2" data-bs-toggle="pill" href="#tab-3">Fresh</Link>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div id="tab-1" className="tab-pane fade show p-0 active">
                    <div className="row g-4">
                        <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div className="product-item">
                                ...
                                <div className="text-center p-4">
                                    <Link to ="" className="d-block h5 mb-2" >Fresh Tomato</Link>
                                ...
                                <div className="d-flex border-top">
                                    <small className="w-50 text-center border-end py-2">
                                        <Link to ="" className="text-body" ><i className="fa fa-eye text-primary me-2"></i>View detail</Link>
                                    </small>
                                    <small className="w-50 text-center py-2">
                                        <Link to ="" className="text-body" ><i className="fa fa-shopping-bag text-primary me-2"></i>Add to cart</Link>
                                    </small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 text-center wow fadeInUp" data-wow-delay="0.1s">
                            <Link to ="" className="btn btn-primary rounded-pill py-3 px-5" >Browse More Products</Link>
                        </div>
                    </div>
                </div>
